...
$packet = $_GET['packet'];
if ($packet == "p1") {
    $namepacket = "for a Day";
    $price = 100000;
    $duration = "1 Day";
} elseif ($packet == "p2") {
    $namepacket = "for a Week";
    $price = 400000;
    $duration = "1 Week";
} elseif ($packet == "p3") {
    $namepacket = "for a Month";
    $price = 1500000;
    $duration = "1 Month";
} elseif ($packet == "p4") {
    $namepacket = "for a Year";
    $price = 10000000;
    $duration = "1 Year";
}
?>
...
<body>
    ...
    <section class="contact_area p_120">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form class="row contact_form" action="../backend/process.php?op=custombooks" method="post">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-1">
                        ...
                        <input type="hidden" class="form-control" id="duration" name="duration" value="<?php echo $duration; ?>">
                    </div>
                    <div class="col-md-3">
