                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" name="loginForm" action="">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="username" aria-describedby="emailHelp" placeholder="Enter Usename...">
                    </div>
                    <div class="form-group">
...
if (isset($_POST['login'])) {
  ...
  if (mysqli_num_rows($query) == 0) {
    ...
    if ($row['level'] == 1) {
      ...
      header("Location: admin/index.php?page=manage_quickb");
    } else if ($row['level'] == 2) {
      $_SESSION['username'] = $username;
      $_SESSION['name'] = $row['name'];
